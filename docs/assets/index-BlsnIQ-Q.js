...
void main() {
	...
	`}var ka=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
      ...
      <section class="content-section about-section" id="about">
        <div class="about-grid">
          <div class="photo-panel">
            <img src="${gc.aboutPhoto}" alt="Jessica Lea speaking on stage" />
          </div>
      ...
      <section class="content-section contact-section" id="contact">
        ...
        <div class="contact-card">
          <div class="contact-photo-panel">
            <img src="${gc.contactPhoto}" alt="Jessica Lea at a keynote event" />
          </div>
...
`,_c();function _c(){let e=document.querySelector(`#signal-canvas`),t=document.querySelector(`.signal-stage`);if(!e||!t)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,r=new mc({canvas:e,alpha:!0,antialias:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,1.5));let i=new un,a=new Mi(-1,1,1,-1,0,1),o=new q(.5,.5),s=new q(.5,.5),c=new q(800,533),l=new q(1,1),u=new Ci,d=u.load(gc.heroPhoto,e=>{e.colorSpace=Me;let{image:t}=e;t?.width&&t?.height&&c.set(t.width,t.height)});d.colorSpace=Me;let f=u.load(gc.heroDepth),p=new $r({uniforms:{uTexture:{value:d},uDepthTexture:{value:f},uProgress:{value:0},uPointer:{value:o.clone()},uResolution:{value:l},uImageResolution:{value:c}},vertexShader:`
      varying vec2 vUv;
    ...
    `}),m=new Dr(new Wr(2,2),p);i.add(m),t.addEventListener(`pointermove`,e=>{let n=t.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width,s.y=(e.clientY-n.top)/n.height}),t.addEventListener(`pointerleave`,()=>{s.set(.5,.5)});let h=()=>{let{clientWidth:e,clientHeight:n}=t;r.setSize(e,n,!1),l.set(e,n),p.uniforms.uResolution.value=l};new ResizeObserver(h).observe(t),h();let g=new Yi,_=()=>{let e=g.getElapsedTime();o.lerp(s,n?1:.08),p.uniforms.uPointer.value.copy(o),p.uniforms.uProgress.value=n?.62:e*.3%1,r.render(i,a),requestAnimationFrame(_)};_()}