...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function za(e,t,n){let r=new Float32Array(Ta),i=new J(0,1,0);return new ci({name:`SphericalGaussianBlur`,defines:{n:Ta,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ha(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(){return new ci({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ha(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Va(){return new ci({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ha(),fragmentShader:`
	...
	`}var Ua=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Kr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
      ...
      <section class="content-section about-section" id="about">
        <div class="about-grid">
          <div class="photo-panel">
            <img src="${Ac.aboutPhoto}" alt="Jessica Lea speaking on stage" />
          </div>
      ...
      <section class="content-section contact-section" id="contact">
        ...
        <div class="contact-card">
          <div class="contact-photo-panel">
            <img src="${Ac.contactPhoto}" alt="Jessica Lea at a keynote event" />
          </div>
...
`,jc();function jc(){let e=document.querySelector(`#signal-canvas`),t=document.querySelector(`.signal-stage`);if(!e||!t)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,r=new Oc({canvas:e,alpha:!0,antialias:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,1.8));let i=new un,a=new Hi(32,1,.1,100);a.position.set(0,.2,8.5);let o=new tn;i.add(o);let s=new Ki(16777215,1.3);i.add(s);let c=new Wi(16777215,16,30);c.position.set(4.5,4.5,7),i.add(c);let l=new Wi(3581098,14,32);l.position.set(-5,-3,6),i.add(l);let u=new Dr(new Qr(1.95,64,64),new di({color:2840194,roughness:.16,metalness:.22,clearcoat:1,clearcoatRoughness:.18,transmission:.08,emissive:1254970,emissiveIntensity:.32}));o.add(u);let d=new Dr(new $r(2.75,.045,12,220),new hr({color:14328405,transparent:!0,opacity:.88}));d.rotation.x=Math.PI/2.5,o.add(d);let f=new Dr(new Qr(2.35,26,26),new hr({color:9257130,wireframe:!0,transparent:!0,opacity:.28}));f.rotation.x=.35,f.rotation.y=.2,o.add(f);let p=new Float32Array(900*3);for(let e=0;e<900;e+=1){let t=e*3,n=3.4+Math.random()*1.8,r=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1);p[t]=n*Math.sin(i)*Math.cos(r),p[t+1]=n*Math.sin(i)*Math.sin(r),p[t+2]=n*Math.cos(i)}let m=new Wr(new ir,new zr({color:7684248,size:.045,transparent:!0,opacity:.5}));m.geometry.setAttribute(`position`,new Un(p,3)),i.add(m);let h=new q(0,0);window.addEventListener(`pointermove`,e=>{let n=t.getBoundingClientRect();h.x=((e.clientX-n.left)/n.width-.5)*2,h.y=((e.clientY-n.top)/n.height-.5)*2});let g=()=>{let{clientWidth:e,clientHeight:n}=t;r.setSize(e,n,!1),a.aspect=e/n,a.updateProjectionMatrix()};new ResizeObserver(g).observe(t),g();let _=new la,v=()=>{let e=_.getElapsedTime();n||(o.rotation.y=e*.25+h.x*.22,o.rotation.x=Math.sin(e*.45)*.12+h.y*.12,u.rotation.y=e*.35,u.rotation.z=Math.sin(e*.3)*.08,d.rotation.z=e*.28,f.rotation.z=-e*.16,m.rotation.y=-e*.045,m.rotation.x=e*.025),r.render(i,a),requestAnimationFrame(v)};v()}